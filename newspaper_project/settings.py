...
SECRET_KEY = '$#9mm6-cgrh0mm#h)i^f3=d$#$xkf%8z1jip+b!w2-=pc5&%)#'
...
DEFAULT_FROM_EMAIL = 'imon@dhakainfotech.com'
EMAIL_HOST = 'smtp.sendgrid.net'
EMAIL_HOST_USER = 'apikey'
EMAIL_HOST_PASSWORD = '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'
EMAIL_PORT = 587
EMAIL_USE_TLS = True
